...
class Ui_projectTab(object):
    def setupUi(self, projectTab):
        ...
        self.gridLayout.addWidget(self.lineEdit_image_folder, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_image, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_label_folder, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_label, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_test_folder, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_test, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_result_folder, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_result, 4, 2, 1, 1)
